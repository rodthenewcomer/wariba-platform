...
/** Design System §24.4 — sensitive consents are never precocked; that's the caller's job (don't pass defaultChecked). */
  ...
  return (
    <div className="flex gap-3">
      <input
        ...
        className={cx(
          'mt-0.5 h-5 w-5 shrink-0 cursor-pointer rounded-[var(--wariba-radius-xs)]',
