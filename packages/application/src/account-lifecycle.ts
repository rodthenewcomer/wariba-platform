...
const VIEW: Record<AccountLifecycleState, Omit<AccountLifecycleView, 'state'>> = {
  ...
  passed: {
    ...
    description: 'Votre compte Performance est en préparation.',
    tone: 'success',
    tradable: false,
    terminal: true,
    awaitingPlatform: true,
  ...
  funded_preparing: {
    label: 'Compte Performance en préparation',
    description: 'Votre compte Performance sera actif dans quelques instants.',
    tone: 'success',
    tradable: false,
    terminal: false,
    awaitingPlatform: true,
  ...
  funded_active: {
    label: 'Compte Performance actif',
    description: 'Votre compte Performance est actif. Vos payouts se débloquent par cycle.',
    tone: 'success',
    tradable: true,
    terminal: false,
    awaitingPlatform: false,
