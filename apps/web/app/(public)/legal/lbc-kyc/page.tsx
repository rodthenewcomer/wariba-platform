  ...
  return (
    <div className="rounded-[var(--wariba-radius-xl)] border border-[color:var(--wariba-accent-amber-edge)] bg-[color:var(--wariba-accent-amber-wash)] px-5 py-6">
      ...
      <p className="mt-2 text-[length:var(--wariba-font-size-body-sm)] leading-relaxed text-[color:var(--wariba-on-dark-muted)]">
        Cette page décrit les contrôles que WARIBA applique. Elle ne conclut pas que Lagoon
        Technologies est une institution assujettie à la loi uniforme LBC/FT/FP au sens strict —
        cette qualification reste un chantier juridique ouvert.
      </p>
    </div>
  );
}
  ...
  return (
    ...
    >
      <LegalSection id="pourquoi" number="1" title="Pourquoi cette politique existe">
        <p>
          WARIBA applique des contrôles d’identité, anti-fraude et de sanctions parce qu’ils
          protègent l’intégrité du programme, la fiabilité des payouts et, le cas échéant, des
          obligations légales applicables — pas parce que WARIBA revendique un statut réglementaire
          particulier.
        </p>
      </LegalSection>
      ...
      <LegalSection id="nature-wariba" number="2" title="Nature de WARIBA">
        <LegalCallout tone="caution" title="Pas une affirmation de statut">
          ...
          établissement de paiement, ni comme une institution légalement désignée assujettie à la
          LBC/FT/FP, tant que cette classification n’est pas confirmée juridiquement.
        </LegalCallout>
      </LegalSection>

      <LegalSection id="verification-identite" number="3" title="Vérification d’identité (KYC)">
        <p>
          Une vérification d’identité peut être demandée avant le traitement d’une demande de
          payout, selon les règles du programme. Le KYC est un dossier de conformité distinct du
          compte de trading&nbsp;: les deux ne se contaminent pas.
        </p>
      </LegalSection>
      ...
      <LegalSection id="donnees-collectees" number="4" title="Données collectées">
        <ul>
          ...
          <li>
            Un contrôle de vivacité (selfie/liveness), lorsque requis par le prestataire utilisé.
          </li>
      ...
      <LegalSection id="prevention-fraude" number="6" title="Prévention de la fraude">
        <p>
          WARIBA surveille les signaux d’abus multi-comptes, d’usurpation d’identité et de
          manipulation de l’environnement simulé, et peut restreindre un compte sur cette base.
        </p>
      </LegalSection>

      <LegalSection id="sanctions" number="7" title="Filtrage et sanctions">
        <p>
          Lorsque cela est requis, WARIBA applique un filtrage relatif aux sanctions internationales
          et peut restreindre l’accès en cas de correspondance ou d’obligation légale applicable.
          WARIBA ne publie pas ses critères de détection internes.
        </p>
      </LegalSection>

      <LegalSection id="activite-suspecte" number="8" title="Activité suspecte">
        <p>
          Une activité jugée suspecte peut faire l’objet d’une revue supplémentaire avant tout
          paiement. Lorsque la loi impose une déclaration, une conservation, une coopération ou une
          mesure de gel, WARIBA agit conformément aux exigences applicables et coopère avec les
      ...
      <LegalSection id="restrictions" number="9" title="Restrictions et refus">
        <p>
          ...
          gouvernementale, une restriction du prestataire de paiement, une incohérence d’identité ou
          un risque de fraude l’exige. Ces mesures ne visent jamais à indiquer aux utilisateurs
          comment contourner les contrôles en place.
        </p>
      </LegalSection>

      <LegalSection id="cooperation" number="10" title="Coopération avec les autorités">
        <p>
          WARIBA coopère avec les autorités compétentes dans les limites et selon les modalités
      ...
      <LegalSection id="conservation" number="11" title="Conservation des dossiers">
        <p>
          ...
          réglementation applicable, dans le respect de la confidentialité des données concernées.
          Voir{' '}
          <a
