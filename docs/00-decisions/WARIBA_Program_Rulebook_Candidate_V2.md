...
Date de décision candidate : 27 août 2026. Statut global : **GO PILOTE révocable — pas LOCK**. Ce document ne modifie aucun fichier du dépôt et ne remplace pas encore la policy publiée.

## Executive Summary

- **Le Rulebook candidat est complet mais il ne peut pas être publié comme policy active sans supersession formelle.** Les valeurs ONE 8/3/8/35/2, FLEX 4/3/6/35/3 et INSTANT 2/5/30/3 contredisent partiellement les paramètres actuellement verrouillés.
- **ONE est le noyau.** Le modèle V1 donne 31,2% de marge Stress à ONE; FLEX tombe à 2,4% en moyenne et doit être limité aux 25K/50K; INSTANT reste une bêta avec réserve dédiée.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| ONE | 8% | 3% | 8% EOD trailing | 2% en Performance | 35% | 5 jours à +0,5%; 80/85/90% | GO PILOTE révocable après supersession |
| FLEX | 4% | 3% | 6% EOD trailing | 3% en Performance | 35% | 5 jours à +0,5%; 80/85/90% | GO PILOTE 25K/50K; reste gated |
| INSTANT | Aucun | 2% | 5% EOD trailing | 3% | 30% | 5 jours à +0,5%; 80/85/90% | Bêta plafonnée; réserve dédiée obligatoire |
...
**Commencez maintenant. Payez le reste après votre réussite.** Tailles 5K à 100K. Target 4%, soft daily 3%, Maximum Loss 6% EOD trailing, Best Day 35%. Le prix d’activation est figé au moment de l’achat et n’est payé qu’après une réussite approuvée. Il reste disponible 30 jours; aucun accès Performance avant paiement. En Performance : daily 3%, max 6%, buffer 3%, Best Day 35%, mêmes 5 jours, splits et caps. Paid scale seulement 25K/50K; 100K limité; 5K/10K non scalés.

## WARIBA INSTANT

**Pas d’évaluation. Commencez directement sur Performance.** Tailles 5K à 100K, mais produit en bêta plafonnée. Soft daily 2%, Maximum Loss 5% EOD trailing, buffer 3%, Best Day 30%, leverage conservateur, marge utilisée maximale 10%, 5 jours à +0,5%, splits et caps communs. 25K est le noyau bêta; 50K/100K ne s’activent qu’avec réserve dédiée; 5K sans paid scale.
...
Les prix doivent être présentés comme le total obligatoire au checkout, taxes et frais obligatoires inclus une fois leur traitement fiscal validé. Pour FLEX, le prix total si succès est figé lors de l’achat afin d’éviter tout bait-and-switch.
...
| Exposition maximale | Il n’y a pas de limite fixe de nombre de positions. WariX refuse un ordre si la marge totale dépasserait 20% en Évaluation, 15% en Performance ONE/FLEX ou 10% en INSTANT. | Ordre refusé; pas breach | CANDIDATE à recalibrer |
...
| EA et bots | Les EA et bots sont autorisés s’ils sont sous votre contrôle et respectent toutes les règles. Les robots qui saturent le serveur ou exploitent le flux sont interdits. | Throttle, pause ou revue | CANDIDATE |
| Copy trading | Vous pouvez copier entre vos propres comptes vérifiés après les avoir liés dans le Hub. Copier depuis ou vers le compte d’une autre personne, vendre un service de passage ou faire gérer le compte est interdit. | Hold d’intégrité ou terminaison après preuve | CANDIDATE |
...
| EA / charge serveur | >60 requêtes/minute ou >2 000/jour | Throttle puis soft technical pause; revue si répétition délibérée | Compteur par compte/device/strategy | CANDIDATE |
| Comptes liés | Copy déclaré | Agrégation par bénéficiaire effectif et stratégie | Ne pas traiter une IP seule comme preuve | CANDIDATE |
...
| ONE 8/3/8/35/2 | CANDIDATE | Product Owner ONE, Pricing, Customer Advocate | Conflit avec le Rulebook verrouillé actuel; Decision Record requis |
...
| EA/bots autorisés | CANDIDATE | Product, Platform, Security | Rate limits, ownership et stratégie dupliquée à détecter |
| Copy propre autorisé | CANDIDATE | Customer Advocate, Fraud, AML/KYC | Owner graph et allocation agrégée indispensables |
...
| Exposition par marge | CANDIDATE | Head of Trading Risk | 20/15/10% à recalibrer sur pilote |
